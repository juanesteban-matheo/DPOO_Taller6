...
public class VentanaAgregarRestaurante extends JFrame
{
    ...
    {
        String newName = this.panelDetalles.getNombre();
        int newRating = this.panelDetalles.getCalificacion();
        boolean newVisited = this.panelDetalles.getVisitado();
        
        //TODO Terminar Ventana Principal!
        this.ventanaPrincipal.mostrarVetanaNuevoRestaurante();
    }
